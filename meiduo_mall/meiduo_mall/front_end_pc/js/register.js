var vm = new Vue({
    ...
    mounted: function () {
        ...
        // 发起请求，请求图片验证码
        // axios.get('http://127.0.0.1:8888/image_codes/' + this.image_code_id + '/')
        // 	.then(response =>{
        //
        // 	})
        // 	.catch(error =>{
        //
        // 	})
        // this.image_code_url = 'http://127.0.0.1:8888/image_codes/' + this.image_code_id + '/'
    ...
    methods: {
        ...
        send_sms_code: function () {
            ...
            axios.get(this.host + "/sms_codes/" + this.mobile + "/?text=" + this.image_code +
