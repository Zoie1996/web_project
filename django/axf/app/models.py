...
class MainShow(Main):
    ...
    price1 = models.FloatField(default=0)  # 折后价格
...
class FoodType(models.Model):
    ...
    childtypenames = models.CharField(max_length=200)  # 商品子名称
...
class Goods(models.Model):
    ...
    price = models.FloatField(default=1)  # 折后价格
